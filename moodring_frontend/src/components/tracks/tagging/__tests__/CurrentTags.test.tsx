...
describe('CurrentTags', () => {
  ...
  describe('Basic Rendering', () => {
    it('renders tags correctly', () => {
      render(<CurrentTags tags={mockTags} onRemoveTag={mockOnRemoveTag} isLoading={false} />);
    ...
    it('renders with empty tags array', () => {
      render(<CurrentTags tags={[]} onRemoveTag={mockOnRemoveTag} isLoading={false} />);
    ...
    it('renders single tag correctly', () => {
      render(<CurrentTags tags={[mockTags[0]]} onRemoveTag={mockOnRemoveTag} isLoading={false} />);
  ...
  describe('Loading State', () => {
    it('disables remove buttons when loading', () => {
      const { UNSAFE_getAllByType } = render(
        <CurrentTags tags={mockTags} onRemoveTag={mockOnRemoveTag} isLoading={true} />
      );
    ...
    it('handles loading state change correctly', () => {
      ...
      rerender(<CurrentTags tags={mockTags} onRemoveTag={mockOnRemoveTag} isLoading={false} />);
  ...
  describe('Tags Prop Changes', () => {
    it('updates when tags prop changes', () => {
      const { rerender } = render(
        <CurrentTags tags={[mockTags[0]]} onRemoveTag={mockOnRemoveTag} isLoading={false} />
      );
    ...
    it('removes tags from display when tags prop changes', () => {
      const { rerender } = render(
        <CurrentTags tags={mockTags} onRemoveTag={mockOnRemoveTag} isLoading={false} />
      );
  ...
  describe('Edge Cases', () => {
    it('handles tags with special characters in names', () => {
      ...
      render(<CurrentTags tags={specialTags} onRemoveTag={mockOnRemoveTag} isLoading={false} />);
    ...
    it('handles tags with very long names', () => {
      ...
      render(<CurrentTags tags={longNameTag} onRemoveTag={mockOnRemoveTag} isLoading={false} />);

      expect(
        screen.getByText('this is a very long tag name that might cause layout issues')
      ).toBeTruthy();
      expect(screen.getByText('×')).toBeTruthy();
    });
    ...
    it('handles tags with empty string names', () => {
      ...
      render(<CurrentTags tags={emptyNameTag} onRemoveTag={mockOnRemoveTag} isLoading={false} />);
    ...
    it('handles duplicate tag ids correctly', () => {
      ...
      render(
        <CurrentTags tags={duplicateIdTags} onRemoveTag={mockOnRemoveTag} isLoading={false} />
      );
  ...
  describe('Component Props Validation', () => {
    ...
    it('handles onRemoveTag function changes', () => {
      ...
      const { rerender } = render(
        <CurrentTags tags={[mockTags[0]]} onRemoveTag={firstHandler} isLoading={false} />
      );
      ...
      rerender(<CurrentTags tags={[mockTags[0]]} onRemoveTag={secondHandler} isLoading={false} />);
