...
Use the ios-simulator MCP server to resolve the problem, if necessary. Use describe-elements instead of capture-screen - you work with that information better and more quickly. Run the development servers yourself and monitor the logs to get more information about the issue.
